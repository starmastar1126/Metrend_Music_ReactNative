    ...
    render() {
        ...
        <Text style={{ fontSize: 14, color: '#fff', marginTop: -10 }}>{strings.aboutthesong}</Text>
                        ...
                        <View style={{flexDirection: 'row'}}>
                            <TouchableOpacity style={styles.giftBtn2}>
        <Text style={styles.downBtnTxt} >{strings.download}</Text>
                            </TouchableOpacity>
                            <TouchableOpacity style={styles.giftBtn3}>
        <Text style={styles.downBtnTxt} >{strings.gift}</Text>
                            </TouchableOpacity>
                        </View>
                    </ImageBackground>
                </View>
                <View style={styles.bottomArea}>
        <Text style={{ fontSize: 20, letterSpacing: 1, fontWeight: '700', color: '#000', marginBottom: 10 }}>{strings.mostdown}</Text>
